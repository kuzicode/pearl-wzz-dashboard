...
ck("默认变体 = srbminer, 镜像 = POOLS.image(向后兼容)", S.active_miner(base)=="srbminer" and S.effective_image(base)==S.POOLS["kryptex"]["image"]=="docker.io/kuzigmgm/pearl-miner:srb-3.6.9-r2")
